...
public class ShoeBag {
    ...
    public ShoeBag(int _type, int _rating, String _lastWorn, int _noOfTimes, int _color, String _comment, int _available, int _topBot, byte[] _photograph) {
        this._type = _type;
