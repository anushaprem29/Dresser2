...
public class ClothesDatabase extends SQLiteOpenHelper {

    public static final String DATABASE_NAME="fclothesdress.db";
    public static final String TABLE_NAME="fclothesdtable";
    ...
    public ClothesDatabase(Context context) {
    ...
    public List<Clothes> readAllClothes(){
        ...
        List<Clothes> contacts = new ArrayList<Clothes>();
        Cursor cursor = db.query(TABLE_NAME, columns, null, null, null, null, null);
        cursor.moveToFirst();        while (!cursor.isAfterLast()) {
            Clothes contact = new Clothes();
