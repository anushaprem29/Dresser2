...
public class GalleryAdapterS extends BaseAdapter {
    private final ShoeBagDatabase handler;
    ShoeBag contact;
    int colorsValue[];
...
//    LinearLayout mDotsLayout;
    ...
    private List<ShoeBag> galleryRows;
    private LayoutInflater inflater;
    private int idColor;
    private LinearLayout mDotsLayout;

    public GalleryAdapterS(Context mContext, List<ShoeBag> galleryRows, ShoeBagDatabase handler3) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ShoeBag contact = galleryRows.get(position);
